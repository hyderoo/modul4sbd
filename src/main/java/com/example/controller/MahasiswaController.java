...
public class MahasiswaController {
    ...
    public String add(Mahasiswa mahasiswa) {
        ...
        jdbcTemplate.update(sql, mahasiswa.getNim(), mahasiswa.getNama(), mahasiswa.getAngkatan(),mahasiswa.getGender(), mahasiswa.getAsal_daerah(), mahasiswa.getNo_telp());
        return "redirect:/";
    }
    ...
    public String edit(Mahasiswa mahasiswa) {
        String sql = "UPDATE mahasiswa SET nama = ?, angkatan = ?, gender = ?, asal_daerah = ?, no_telp = ? WHERE nim = ?";
        jdbcTemplate.update(sql, mahasiswa.getNama(), mahasiswa.getAngkatan(), mahasiswa.getGender(), mahasiswa.getAsal_daerah(), mahasiswa.getNo_telp(), mahasiswa.getNim());
        return "redirect:/";
    }
